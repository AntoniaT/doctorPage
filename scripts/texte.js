...
const leistungen = [
    {
        ...
        copy: 'Oberbauchbeschwerden sind keine Seltenheit. Speiseröhre, Magen und Zwölffingerdarm werden von innen, mit Hilfe eines flexiblen Endoskops, optisch untersucht. Durch diese Untersuchung wird eine Beurteilung von Veränderungen wie zum Beispiel Entzündungen, Polypen (gutartige Wucherungen der Schleimhaut) oder Geschwüre ermöglicht, um frühzeitig die richtige Diagnose und Therapie zu finden.  Je nach Notwendigkeit werden im Zuge der Magenspiegelung Gewebeproben entnommen, welche zur weiteren histologischen Untersuchung eingesandt werden. Sollte eine Polypen-Entfernung (Polypektomie) notwendig werden, so kann dies ebenfalls im Rahmen der Untersuchung durchgeführt werden.',
        copy2: ''
    },
    {
        id: 2,
        title: 'Koloskopie (Darmspiegelung)',
        copy: 'Die Darmspiegelung ist ein wesentlicher Bestandteil der Vorsorgemedizin und wird ab dem vollendeten 50. Lebensjahr empfohlen. Darmpolypen stellen die häufigste Vorstufe von Darmkrebs dar. Zellen dieser zunächst gutartigen Schleimhautwucherungen haben eine hohe Neigung sich im Laufe der Zeit in bösartige Zellen umzuwandeln. Mit der Darmspiegelung im Rahmen der Darmkrebsfrüherkennung können Polypen rechtzeitig diagnostiziert und behandelt werden.',
        copy2: 'Sollten Sie, oder Ihr Hausarzt im Rahmen der Gesundenuntersuchung Blut im Stuhl festgestellt haben sollte dies sofort abgeklärt werden. Die Darmspiegelung gilt hier als „Goldstandard“-Mittel der Wahl. Um Ihnen eine  schmerzfreie und sanfte Gastroskopie als auch Koloskopie zu ermöglichen, werden diese Untersuchungen unter leichter Sedierung (Dämmerschlaf) durchgeführt.'
    },
    {
        id: 3,
        title: 'Mammachirurgie, Senologie, Brustkrebs und männliche Gynäkomastie',
        copy: 'Brustkrebs ist die häufigste bösartige Erkrankung der Frau. Die chirurgische Therapie stellt einen essentiellen Pfeiler der multiprofessionellen Therapie im Kampf gegen den Brustkrebs dar. Der Einsatz modernster Techniken in der Rekonstruktion sowie der onkoplastischen Rekonstruktion ermöglicht die onkologische Sicherheit mit sehr guten kosmetischen Ergebnissen zu kombinieren.',
        copy2: 'Sowohl gutartige Veränderungen der Brustdrüse wie Fibroadenome, eine männliche Gynäkomastie, als auch bösartigen Veränderungen sind gut therapierbar.'
    },
    {
        id: 4,
        title: 'Leistenbruch',
        copy: 'Bei einem Leistenbruch kann zwischen angeborenen und erworbenen unterschieden werden. Bei dem erworbenen Leistenbruch fördert erhöhter Druck im Bauchraum durch mechanische Reize wie Husten oder schwere Arbeit/schweres Heben seine Entstehung. Meist wird ein Schmerz in der Leiste bemerkt welcher sich bei Zunahme der Größe als Schwellung in der Leiste manifestiert.  Die Sanierung des Leistenbruches ist nur durch eine Operation möglich.',
        copy2: 'Die operative Therapie wird auf die individuellen Bedürfnisse abgesimmt, zu den gängigsten Methoden zählt der Hernienrepair mittels Bauchspiegelung (Transabdominelle Präperitoneale Plastik) sowie die Operation nach Lichtenstein mittels Hautschnitt.'
    },
    {
        id: 5,
        title: 'Nabelbruch',
        copy: 'Der Nabel stellt eine Schwachstelle in der Bauchdecke dar. Im Laufe des Lebens kann es an dieser Stelle zur Ausdünnung der Faszie kommen und es entsteht ein Nabelbruch. Die klinische Präsentation beginnt meist mit brennenden Schmerzen in der Nabelgegend. Mit der Zeit und je nach Belastung entseht eine Vorwölbung in der Nabelgrube welche bei oder auch ohne Belastung schmerzhaft wird.',
    ...
    },
    {
        id: 7,
        title: 'Gallenblase',
        copy: 'Gallensteine werden häufig durch kolikartige Schmerzen symptomatisch. Der „westliche“ Lebensstil mit hochkalorischer Ernährung und wenig Bewegung fördert die Entstehung der Gallensteine. Es kann zu einer Gallenblasenentzündung kommen welche sich durch starke Schmerzen unter dem Rippenbogen bemerkbar macht.',
        copy2: 'Eine operative, meist durch Knopflochchirurgie, Entfernung der Gallenblase gilt als Therapie der Wahl.'
    },
    {
        id: 8,
        title: 'Erkrankungen der Schilddrüse und Nebenschilddrüse',
    ...
    {
        id: 12,
        title: 'Appendizitis und Blinddarmbeschwerden',
    ...
    {
        id: 13,
        title: 'Darmchirurgie und Rektumchirurgie',
    ...
    {
        id: 15,
        title: 'Pilonidalsinus, Steißbeinfistel und Sakraldermoid',
    ...
    {
        id: 17,
        title: 'Enddarmbeschwerden und Hämorrhoiden',
    ...
    {
        id: 19,
        title: 'Fisteln, Abszeße und Perianalvenenthrombose',
